...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/AKSegmentedControl/AKSegmentedControl.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Bumblebee/Bumblebee.framework"
  install_framework "$BUILT_PRODUCTS_DIR/DateTools/DateTools.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ImageFilesPicker/ImageFilesPicker.framework"
